...
fn render_vehicle_diagnostics(
    ...
    ui.columns(2, |columns| {
        // Left column: vehicle state and plots.
        ...
        Plot::new("altitude_plot")
            ...
            .show(ui, |plot_ui| {
                plot_ui
                    .line(Line::new("altitude", altitude_points).color(egui::Color32::LIGHT_BLUE));
                plot_ui.line(
        ...
        ui.collapsing("Hover tuning", |ui| {
            ...
            ui.add(egui::Slider::new(&mut hover_config.spring, 10000.0..=100000.0).text("Spring"));
            ui.add(egui::Slider::new(&mut hover_config.damper, 5000.0..=50000.0).text("Damper"));
            ui.add(
        ...
        ui.collapsing("Movement tuning", |ui| {
            ...
            ui.add(
                egui::Slider::new(&mut movement_config.jump_force, 0.0..=1000.0).text("Jump force"),
            );
        });
        ...
        ui.collapsing("Handling tuning", |ui| {
            ...
            ui.add(
                egui::Slider::new(&mut movement_config.max_bank_angle, 0.0..=0.8).text("Max bank"),
            );
            ui.add(egui::Slider::new(&mut movement_config.bank_rate, 1.0..=20.0).text("Bank rate"));
            ui.add(
        ...
        ui.collapsing("Drag tuning", |ui| {
            ui.add(
                egui::Slider::new(&mut drag_config.forward_drag, 0.0..=10.0).text("Forward drag"),
            );
            ui.add(
                egui::Slider::new(&mut drag_config.lateral_drag, 0.0..=30.0).text("Lateral drag"),
            );
            ui.add(
                egui::Slider::new(&mut drag_config.angular_drag, 0.0..=2.0).text("Angular drag"),
            );
            ui.add(
