#define_import_path veldera_clouds::functions

#import bevy_render::maths::{PI, HALF_PI, fast_acos_4, fast_atan2, ray_sphere_intersect};
#import veldera_atmosphere::bruneton_functions::transmittance_lut_r_mu_to_uv;
#import veldera_clouds::bindings::{
...
#import veldera_clouds::climate::climate_coverage_at;
#import veldera_clouds::types::CONE_OFFSETS;
...
// Mirrors `veldera_atmosphere::functions::direction_world_to_atmosphere`.
...
//
// Mirrors `veldera_atmosphere::functions::sample_sky_view_lut` /
