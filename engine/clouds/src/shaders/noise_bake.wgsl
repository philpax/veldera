...
// Injected as a `shader_def` from the host `NOISE_RES` constant (see
// `NoisePipeline` in noise.rs), so it tracks the texture this shader fills.
const NOISE_RES: u32 = #{NOISE_RES}u;
